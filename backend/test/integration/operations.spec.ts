...
const ba = (branchId: string) => ({ staffId: '00000000-0000-0000-0000-0000000000cc', name: 'Test User', username: 'ba', role: 'branch_admin', orgId: TEST_ORG, branchId, doctorId: null });
const doc = (branchId: string) => ({ staffId: '00000000-0000-0000-0000-0000000000dd', name: 'Test User', username: 'dr', role: 'doctor', orgId: TEST_ORG, branchId, doctorId: '00000000-0000-0000-0000-0000000000dd' });
